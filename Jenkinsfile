  ...
  stages {
    ...
    post {  
         ...
         success {   
            ...
            emailext attachLog: true, body: "<b>Example</b><br>Project: ${env.JOB_NAME}", from: 'agsanjeevkumar96@gmail.com', mimeType: 'text/html', replyTo: '', subject: "Deploy Success CI: Project name -> ${env.JOB_NAME}", to: "agsanjeevkumar96@gmail.com";
         }  
         failure {  
